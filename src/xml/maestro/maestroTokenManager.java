/* maestroTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. maestroTokenManager.java */
package xml.maestro;
...
private int jjMoveStringLiteralDfa1_0(long active0){
   ...
   {
      case 47:
         return jjMoveStringLiteralDfa2_0(active0, 0x54L);
      case 68:
      case 100:
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public maestroTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public maestroTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
