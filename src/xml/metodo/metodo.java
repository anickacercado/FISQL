...
public class metodo implements metodoConstants {
  ...
  final public ArrayList<procedure> S() throws ParseException {
    PROC();
{if ("" != null) return lproc;}
    throw new Error("Missing return statement in function");
  }

  final public void PROC() throws ParseException {Token t,cod;
...
nombre_proc= t.image;
  ...
  final public void PARAMS() throws ParseException {Token t,tip;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case TOKEN_INTEGER_ABRE:{
...
tipo = tip.image;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x2aaa00,0x2,0x2aaa00,0x2aaa00,};
   }
