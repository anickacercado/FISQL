/* paqueteTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. paqueteTokenManager.java */
package paquetes;
import  archivos.memoria;

/** Token Manager. */
@SuppressWarnings("unused")public class paqueteTokenManager implements paqueteConstants {
...
static final int[] jjnextStates = {
   12, 20, 26, 34, 46, 50, 55, 63, 69, 73, 78, 79, 80, 1, 2, 79, 
   80, 
};

/** Token literal values. */
public static final String[] jjstrLiteralImages = {
"", "\133", "\135", "\54", "\72", null, null, null, null, null, null, null, 
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public paqueteTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public paqueteTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
